...
const FeatureCard = ({ title, description, icon, color }: FeatureCardProps) => {
  return (
    ...
    >
      ...
      <h3 className="text-xl font-semibold mb-3 text-white/90 drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]
                     group-hover:scale-105 transition-transform duration-300">
        {title}
      </h3>
      <p className="text-white/70 leading-relaxed drop-shadow-[0_0_5px_rgba(255,255,255,0.5)]">
        {description}
      </p>
    </motion.div>
  );
