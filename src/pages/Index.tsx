  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-background/95 to-background">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-0 left-0 w-[800px] h-[800px] bg-[#0EA5E9]/40 rounded-full 
                      filter blur-[180px] animate-[float-slow_30s_ease-in-out_infinite] transform-gpu"></div>
        <div className="absolute bottom-0 right-0 w-[800px] h-[800px] bg-[#F97316]/40 rounded-full 
                      filter blur-[180px] animate-[float-medium_25s_ease-in-out_infinite] transform-gpu delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
                      w-[1000px] h-[1000px] bg-[#0EA5E9]/40 rounded-full 
        ...
        <div className="absolute top-1/4 right-1/4 w-[600px] h-[600px] bg-[#0EA5E9]/30 rounded-full 
                      filter blur-[150px] animate-[pulse-slow_15s_ease-in-out_infinite] transform-gpu delay-700"></div>
        <div className="absolute bottom-1/4 left-1/4 w-[600px] h-[600px] bg-[#F97316]/30 rounded-full 
        ...
        <div className="absolute top-1/3 left-2/3 w-[400px] h-[400px] bg-[#0EA5E9]/25 rounded-full 
                      filter blur-[120px] animate-[pulse-fast_10s_ease-in-out_infinite] transform-gpu delay-300"></div>
        <div className="absolute bottom-1/3 right-2/3 w-[400px] h-[400px] bg-[#0EA5E9]/25 rounded-full 
      ...
      <div className="absolute inset-0 border border-[#0EA5E9]/20 
                    shadow-[inset_0_0_150px_rgba(14,165,233,0.4),0_0_70px_rgba(14,165,233,0.3)] 
