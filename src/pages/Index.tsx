  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#070B1A]">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-0 left-0 w-[800px] h-[800px] bg-[#0EA5E9]/50 rounded-full 
                      filter blur-[180px] animate-[float-slow_30s_ease-in-out_infinite] transform-gpu"></div>
        <div className="absolute bottom-0 right-0 w-[800px] h-[800px] bg-[#33C3F0]/50 rounded-full 
                      filter blur-[180px] animate-[float-medium_25s_ease-in-out_infinite] transform-gpu delay-1000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
                      w-[1000px] h-[1000px] bg-[#1EAEDB]/50 rounded-full 
        ...
        <div className="absolute top-1/4 right-1/4 w-[600px] h-[600px] bg-[#0EA5E9]/40 rounded-full 
                      filter blur-[150px] animate-[pulse-slow_15s_ease-in-out_infinite] transform-gpu delay-700"></div>
        <div className="absolute bottom-1/4 left-1/4 w-[600px] h-[600px] bg-[#33C3F0]/40 rounded-full 
                      filter blur-[150px] animate-[pulse-medium_12s_ease-in-out_infinite] transform-gpu delay-1500"></div>
      </div>

      {/* Enhanced neon border effect */}
      <div className="absolute inset-0 border border-[#0EA5E9]/30 
                    shadow-[inset_0_0_150px_rgba(14,165,233,0.5),0_0_70px_rgba(14,165,233,0.4)] 
