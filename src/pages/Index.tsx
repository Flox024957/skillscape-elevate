    ...
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-b from-background/95 to-background">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
                      w-[1000px] h-[1000px] bg-[#8B5CF6]/40 rounded-full 
        ...
        <div className="absolute top-1/3 left-2/3 w-[400px] h-[400px] bg-[#8B5CF6]/25 rounded-full 
      ...
      <div className="absolute inset-0 border border-[#8B5CF6]/20 
                    shadow-[inset_0_0_150px_rgba(139,92,246,0.4),0_0_70px_rgba(139,92,246,0.3)] 
